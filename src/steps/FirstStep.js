...
export default class FirstStep extends React.Component {
    ...
    clicked = (area) => {
        this.setState({ selectedBodypart: area });
    ...
    submitModal = () => {
        ...
        let obj = { subBodyPart: this.findArrayElementById(zones, selectedSubBodyPart), symptoms: arr };
    ...
    getSymptomsFromSubCategory = (subCategoryId) => {
            ...
            <div className="firststep-wrapper">
                <Row type="flex" >
                    <Col className="firststep-descr">
                        ...
                        <Button onClick={() => { this.setState({ selectedBodypart: { id: 17, name: "General, Joints and Skin" } }); this.openModal(17); }} style={{ marginBottom: 20 }} block>General, Joints and Skin</Button>
                        <List
                    ...
                    <Col className="firststep-body" style={{ "width": "50%", marginTop: -50, marginBottom: -40 }}>
                        <ImageMapper
                            className="mapper"
                            src={body}
                            map={MAP}
                ...
                <Modal
                    title={selectedBodypart ? selectedBodypart.name : "Title"}
                    visible={visible}
